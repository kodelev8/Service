...
public class TaxGroupedCollectieveAangifteModel
{
    public string TaxNo { get; set; }
    public List<ForGrouopingCollectieveAangifteModel> CollectieveAangifte { get; set; }
}

public class ForGrouopingCollectieveAangifteModel
{
