...
{
    public class WhenGetKlantById : KlantRepositorySpec
    {
        public class AndException : WhenGetKlantById
        {
            [Fact]
            public async void ThenException()
            {
                ...
                //Act
                var result = await Subject.HandleAsync(new KlantRepository.GetKlantById {KlantId = "633129fb572a926667ed8c5d"}, CancellationToken.None);
        ...
        public class AndNoDataFound : WhenGetKlantById
        {
            [Fact]
        ...
        public class AndDataFound : WhenGetKlantById
        {
            [Fact]
